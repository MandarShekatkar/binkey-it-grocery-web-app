      ...
      <div className=''>
        ...
        <div className='grid relative'>
          ...
          <div className='w-full -ml-4 h-full flex justify-between absolute items-center'>
            <button onClick={handleScrollLeft} className='bg-white z-10 p-1 rounded-full relative shadow-lg '>
              <FaAngleLeft />
            </button>
            <button onClick={handleScrollRight} className='bg-white z-10 p-1 rounded-full relative shadow-lg '>
              <FaAngleRight />
            </button>
          </div>
        </div>
            ...
            <div className='flex items-center gap-4 my-4'>
             ...
             className='w-20 h-20'
              ...
              <div className='text-sm'>
                ...
                <p>Get Your Order Deliver To You Doorstep At The Earliest From Dark Stores Near You.</p>
              </div>
            </div>
            <div className='flex items-center gap-4 my-4'>
              <img 
