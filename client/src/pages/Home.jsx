  ...
  console.log(url)
   ...
   <section className='bg-white'>
    <div className=' bg-slate-200 container mx-auto'>
      <div className={`w-full min-h-48 bg-blue-100 ${!banner && animate-pulse } rounded my-2`}>
      <img 
      src={banner}
...
<div className='container mx-auto px-4 my-2 grid grid-cols-5 md:grid-col-8 lg:grid-cols-10 gap-2'>
      {
        loadingCategory ? (
