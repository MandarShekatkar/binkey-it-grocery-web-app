...
const Profile = () => {
  ...
  return (
    <div className='p-4'>
      ...
      <button onClick={()=>setProfileAvatarEdit(true)} className='text-sm min-w-20 border
     border-primary-100 hover:border-primary-200 hover:bg-primary-200
      px-3 py-1 rounded-full mt-3'>Edit</button>
      ...
      <form className='my-4 grid gap-4' onSubmit={handleSubmit}>
        <div className='grid'>
            ...
            className='p-2 bg-blue-50 outline-none border
             focus-within:border-primary-100 rounded'
             value={userData.name}
             name='name'
